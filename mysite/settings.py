...
SECRET_KEY = 'django-insecure-5vd@i_pp90nbrsz@%_2=o&kye!%5$7b-_-bdnj(tdqtu%(a*gs'
...
# CKEDITOR_5_FILE_STORAGE = os.path.join(MEDIA_ROOT, 'ckeditor5') # optional
CKEDITOR_5_CONFIGS = {
    'default': {
